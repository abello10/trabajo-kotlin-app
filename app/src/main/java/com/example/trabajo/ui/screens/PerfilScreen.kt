...
fun PerfilScreen(
    ...
    val pickFromGallery = rememberLauncherForActivityResult(
        ...
        if (uri != null) {
            ...
            scope.launch { setUserPhoto(ctx, uri) }
        }
    }
    ...
    LaunchedEffect(Unit) {
        ...
        if (!p.isNullOrBlank()) viewModel.onContrasenaChange(p)
        ...
        Column(
            ...
            Card(
                ...
                Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Row {
                        val masked = "•".repeat(estado.contrasena.length.coerceAtLeast(4))
                        Text(if (showPass) estado.contrasena else masked, color = Color.White)
